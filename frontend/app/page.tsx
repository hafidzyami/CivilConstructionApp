        ...
        <div className="max-w-6xl w-full">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Advanced tools for infrastructure mapping, analysis, and construction project
              management
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <div className="relative">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-4">Infrastructure Explorer</h2>
                <p className="text-slate-600 text-lg leading-relaxed mb-6">
                  Explore and analyze infrastructure data including buildings, roads, railways, and
                  waterways using OpenStreetMap technology
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-4">Document OCR</h2>
                <p className="text-slate-600 text-lg leading-relaxed mb-6">
                  Extract text from construction documents and blueprints using advanced OCR with
        ...
        <div className="relative">
          ...
          <div className="flex items-center text-orange-600 font-semibold group-hover:gap-3 gap-2 transition-all duration-300">
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 text-lg leading-relaxed mb-6">
                  Comprehensive API documentation for integrating civil construction data and
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-sm text-slate-400">
              © 2025 Civil Construction Platform. Built with Next.js
            </p>
          </div>
        </div>
      </div>
